...
extension CodeHighlighting where Self == XcodeDefaultDark {
    public static var xcodeDefaultDark: XcodeDefaultDark { XcodeDefaultDark() }
}

public struct XcodeDefaultDark: CodeHighlighting {

    public func color(for token: Token) -> Color {
        switch token.classification {
        case .attribute: Color(red: 0.74902, green: 0.521569, blue: 0.333333, opacity: 1)
        case .character: Color(red: 0.815686, green: 0.74902, blue: 0.411765, opacity: 1)
        case .comment: Color(red: 0.423943, green: 0.474618, blue: 0.525183, opacity: 1)
        case .commentDoc: Color(red: 0.423943, green: 0.474618, blue: 0.525183, opacity: 1)
        case .commentDocKeyword: Color(red: 0.572549, green: 0.631373, blue: 0.694118, opacity: 1)
        ...
        case .identifierClass: Color(red: 0.619608, green: 0.945098, blue: 0.866667, opacity: 1)
        case .identifierClassSystem: Color(red: 0.815686, green: 0.658824, blue: 1, opacity: 1)
        ...
        case .identifierFunction: Color(red: 0.403922, green: 0.717647, blue: 0.643137, opacity: 1)
        case .identifierFunctionSystem: Color(red: 0.631373, green: 0.403922, blue: 0.901961, opacity: 1)
        case .identifierMacro: Color(red: 0.991311, green: 0.560764, blue: 0.246107, opacity: 1)
        case .identifierMacroSystem: Color(red: 0.992157, green: 0.560784, blue: 0.247059, opacity: 1)
        ...
        case .mark: Color(red: 0.572549, green: 0.631373, blue: 0.694118, opacity: 1)
